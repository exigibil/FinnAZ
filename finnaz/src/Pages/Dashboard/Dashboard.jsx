...
import ActiveData from "../../Componenets/ActivePasive/ActiveData";
import PasiveData from "../../Componenets/ActivePasive/PasiveData";
  ...
  return (
    <div className={styles.dashboardContainer}>
      ...
      <div className={styles.dashboardActivePasive}>
        ...
        <div className={styles.financialsStats}>TODO: Indicatori</div>
      </div>
    </div>
  );
};
